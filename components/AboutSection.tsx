  ...
  return (
    <section id="about">
      <div className="bg-gray-100 dark:bg-black rounded-2xl my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="ml-10 mr-10 flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
            ...
            <div className="flex flex-wrap flex-row justify-center z-10 md:justify-start md:py-10">
              {skills.map((item, idx) => {
                return (
                  <p
                    key={idx}
                    className="bg-purple-300 px-4 py-2 mr-2 mt-2 text-gray-500 hover:bg-teal-600 hover:text-gray-100 rounded font-semibold"
                  >
                    {item.skill}
                  </p>
                )
